...
import ma.ens.securite.jwt.FiltreAutorisationJwt;
...
public class SecuriteConfig {
    ...
    private final FiltreAutorisationJwt filtreJwt;

    public SecuriteConfig(FiltreAutorisationJwt filtreJwt) {
    ...
    public SecurityFilterChain chaineFiltresSecurite(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/gestionnaire/**").hasAnyRole("GESTIONNAIRE", "ADMINISTRATEUR")
                        .requestMatchers("/api/utilisateur/**").hasAnyRole("UTILISATEUR", "GESTIONNAIRE", "ADMINISTRATEUR")
